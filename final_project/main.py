...
cursor.execute( """
    ...
    on 1=1
    	and stg.terminal_id = dim.terminal_id
...
cursor.execute( """
    update de11an.kart_dwh_dim_terminals_hist th
    set
    ...
    where 1=1
    	and th.terminal_id = tmp.terminal_id
...
--		and	stg.terminal_address = dim.terminal_address
...
cursor.execute( """
    ...
    where 1=1
        and dim.terminal_id in (
            select 
            	dim.terminal_id
            from de11an.kart_dwh_dim_terminals_hist dim2
            left join de11an.kart_stg_terminals_del stg
            on stg.terminal_id = dim.terminal_id
            where 1=1
                and stg.terminal_id is null
                and dim2.effective_to = to_date( '9999-12-31', 'YYYY-MM-DD' )
                and dim2.deleted_flg = FALSE
        )
        and dim.effective_to = to_date( '9999-12-31', 'YYYY-MM-DD' )
        and dim.deleted_flg = FALSE;	
""")
cursor.execute( """
    update de11an.kart_dwh_dim_terminals_hist dim
    set 
    ...
    where 1=1
        and dim.terminal_id in (
            ...
            from de11an.kart_dwh_dim_terminals_hist dim2
            left join de11an.kart_stg_terminals_del stg
            on stg.terminal_id = dim2.terminal_id
            where 1=1
                and stg.terminal_id is null
                and dim2.effective_to = to_date( '9999-12-31', 'YYYY-MM-DD' )
                and dim2.deleted_flg = FALSE
